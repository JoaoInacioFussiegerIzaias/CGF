class CadastrosController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to cadastros_path, status: :see_other, notice: "Cadastro was successfully destroyed." }
  ...
  private
    ...
    def set_cadastro
      @cadastro = Cadastro.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def cadastro_params
      params.expect(cadastro: [ :nome, :idade, :cpf, :telefone, :cep, :cidade, :rua, :estado, :complemento ])
    end
end
